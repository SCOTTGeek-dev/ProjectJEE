...
public class ItemDTO {
    ...
    public String deadline;  // Added deadline field
    ...
    public ItemDTO(Item itemEntity) {
        ...
        if (itemEntity.getDeadline() != null) {
            this.deadline = itemEntity.getDeadline().getDueDate().toString(); // Assuming dueDate is of type java.util.Date
        }

        // Check if team member is not null before accessing its properties
        if (itemEntity.getTeamMemberOfItem() != null) {
    ...
    public String toString() {
        return "ItemDTO{" +
                ...
                ", deadline='" + deadline + '\'' +  // Added deadline to the toString method
                '}';
    }
}
